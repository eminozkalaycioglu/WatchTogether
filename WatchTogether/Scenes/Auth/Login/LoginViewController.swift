...
extension LoginViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        return collectionView.dequeueReusableCell(withReuseIdentifier: "AvatarCollectionViewCell", for: indexPath)
    }
...
class LoginViewController: WTViewController {
    ...
    override func setup() {
        ...
        testCollection.register(UINib(nibName: "AvatarCollectionViewCell", bundle: nil),
                                forCellWithReuseIdentifier: "AvatarCollectionViewCell")
        testCollection.dataSource = self
        
        
        testCollection.collectionViewLayout = ZoomAndSnapFlowLayout()
